...
export const Stock = () => {
  ...
  const TableRow = ({ id, item, estoque_minimo, qtd_disponivel, categoria }: any) => {
    return (
    ...
    <div className={styles.mainGrid}>
      ...
      <div className={styles.table}>
        ...
        <div className={styles.tableFilter} style={{ gridTemplateColumns }}>
          ...
          <Select
            array={[{ id: 0, categoria: "Todos" }, ...(categories.data?.data || [])]}
            name="categoria"
        ...
        <div className={styles.tableContent}>
          <FlatList list={materials || []} renderItem={TableRow} renderWhenEmpty={() => <p>Nada para mostrar.</p>}></FlatList>
        </div>
      </div>
    </div>
  );
